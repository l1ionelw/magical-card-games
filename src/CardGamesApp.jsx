...
// ---------- Blackjack Game (stub - plug in your full game here) ----------

function BlackjackGame() {
    const navigation = useNavigation();
    return (
        <div style={{ padding: 32, textAlign: "center", color: "#fff" }}>
            <h2 style={{ fontWeight: "bold", fontSize: 35, marginBottom: 20 }}>
                Blackjack
            </h2>
            <div style={{ fontSize: 22, opacity: 0.8, marginBottom: 24 }}>
                (Blackjack game UI goes here)
            </div>
            <button
                onClick={navigation.goHome}
                className="cg-btn"
